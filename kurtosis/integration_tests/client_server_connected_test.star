...
def test(plan):
    ...
    portal_server = portal_launcher.launch_portal(plan, server_name, server_only=True)
    ...
    portal_client = portal_launcher.launch_portal(plan, client_name, server_only=False, current_context_id=remote_context_id, remote_contexts=remote_contexts)
