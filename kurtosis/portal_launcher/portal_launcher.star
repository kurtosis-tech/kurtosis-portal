...
# MISC constants
PORTAL_IMAGE_NAME = "kurtosistech/kurtosis-portal:latest"
...
def launch_portal(plan, service_name, server_only=False, current_context_id=DEFAULT_CONTEXT_ID_AND_NAME, remote_contexts={}):
